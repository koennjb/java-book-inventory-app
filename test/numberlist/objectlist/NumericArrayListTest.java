...
/**
 * This class tests the NumericArrayList class to make sure all of its methods
...
public class NumericArrayListTest {
    ...
    /**
     * Test of add method, of class NumericArrayList to add $100 to end of array
     * list.
     *
    ...
    /**
     * Test of add method with no parameters, of class NumericArrayList to add
     * $200 to end of array list.
     *
     * @throws numberlist.InvalidIndexException
     */
    @Test
    ...
    /**
     * Test of add method, of class NumericArrayList to add $500 in the middle
     * of array list.
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    /**
     * Test of add method, of class NumericArrayList to add two numbers to same
     * index.
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    /**
     * Test of removeAt method, of class NumericArrayList to remove the first
     * index.
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    /**
     * Test of removeAt method, of class NumericArrayList to remove the middle
    ...
    /**
     * Test of removeAt method, of class NumericArrayList to remove the last
     * index.
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    /**
     * Test of remove method, of class NumericArrayList to remove $500 from
     * array list
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    /**
     * Test of get method, of class NumericArrayList to get the value of first
     * index.
     *
     * @throws numberlist.InvalidIndexException
     */
    ...
    public void testGetCountAdded() throws InvalidIndexException {
        ...
        NumericArrayList myList = new NumericArrayList();
    ...
    public void testDeepCopy() throws InvalidIndexException {
        ...
        NumericArrayList copy = testList.deepCopy();
        assertFalse(testList == copy);
        assertFalse(testList.getCount() != copy.getCount());
        for (int i = 0; i < copy.getCount(); i++) {
            assertFalse(testList.get(i) == copy.get(i));
            assertFalse(((Money) testList.get(i)).getDollars()
                    != ((Money) copy.get(i)).getDollars());
            assertFalse(((Money) testList.get(i)).getCents()
                    != ((Money) copy.get(i)).getCents());
        }
